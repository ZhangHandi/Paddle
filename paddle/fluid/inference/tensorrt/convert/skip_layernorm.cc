...
class SkipLayerNormOpConverter : public OpConverter {
 public:
  void operator()(const framework::proto::OpDesc& op,
    ...
    //std::cout << "intpu1 type line36 = fp16: " << (input1->getType() == nvinfer1::DataType::kHALF) << std::endl;
    //std::cout << "intpu2 type line37 = fp16: " << (input2->getType() == nvinfer1::DataType::kHALF) << std::endl;
